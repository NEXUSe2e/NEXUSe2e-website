<template>
  <v-row>
    <v-col cols="12">
      ...
      <TheImage :src="directory_scanner" />
...
import TheImage from '@/components/theImage/TheImage.vue'

import directory_scanner from '@/assets/directory_scanner1.png'
...
### #3 Delete File
Decide whether the file is deleted, after the files is safely stored in NEXUSe2e. If the files are not deleted by NEXUSe2e, they need to be manually removed, otherwise the service will pick up the file as a new message with the next scheduled run.
