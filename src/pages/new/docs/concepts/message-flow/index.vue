<template>
  <v-row>
    <v-col cols="12">
      ...
      <NEXUSe2eImage src="@/assets/message_flow_simple.svg" />
      ...
      <v-table>
        ...
        <tbody>
          <tr>
            ...
            <td>RESOLVED</td>
            <td>
              After the message is successfully processed through the Inflow Service Resolver Pipeline and the Route
              Inflow Pipelet. It´s the first status a message receives.
            </td>
          </tr>
          <tr>
            ...
            <td>
              Action pipeline was successfully executed and the message waits for further processing in the Outflow
          ...
          <tr>
            ...
            <td>QUEUE_ACTION</td>
            <td>
              If the message failed in the action pipeline and the retry limit is not reached. The message will be
              automatically requeued at the action pipeline.
            </td>
          </tr>
          <tr>
            ...
            <td>QUEUE_SENDER</td>
            <td>
              If the message failed in the Outflow Service Resolver Pipeline and the retry limit is not reached. The
              message will be automatically requeued at the Outflow Service Resolver Pipeline.
            </td>
          </tr>
          <tr>
            ...
            <td>
              If the message was successfully sent, but an acknowledgment has not yet be received. If the message
              reaches the next requeue time it will be sent again.
            </td>
          </tr>
          <tr>
            <td>Stopped</td>
          ...
          <tr>
            ...
            <td>TRANSFERRED</td>
            <td>
              After the message is successfully processed through the Outflow Service Resolver Pipeline and sent to the
              target system.
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              Message was successfully sent, but never received an acknowledgment and retry limit has been reached.
            </td>
          </tr>
        </tbody>
      </v-table>
