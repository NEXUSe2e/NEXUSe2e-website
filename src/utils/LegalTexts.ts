...
**Umsatzsteuer-Identifikationsnummer:** DE 207968204

**Vertreten durch:** Mathias Krüger, Tobias Joswig


`)

export const privacyPolicy = marked(`
...
## Verantwortlicher
evolving systems consulting GmbH<br />
Alter Wall 34-36<br />
20457 Hamburg<br />
...
**Beschwerde bei Aufsichtsbehörde:** Sie haben unbeschadet eines anderweitigen verwaltungsrechtlichen oder gerichtlichen Rechtsbehelfs das Recht auf Beschwerde bei einer Aufsichtsbehörde, insbesondere in dem Mitgliedstaat ihres gewöhnlichen Aufenthaltsorts, ihres Arbeitsplatzes oder des Orts des mutmaßlichen Verstoßes, wenn Sie der Ansicht sind, dass die Verarbeitung der Sie betreffenden personenbezogenen Daten gegen die Vorgaben der DSGVO verstößt.<br />

## Einsatz von Cookies

Cookies sind kleine Textdateien, bzw. sonstige Speichervermerke, die Informationen auf Endgeräten speichern und Informationen aus den Endgeräten auslesen. Z. B. um den Login-Status in einem Nutzerkonto, einen Warenkorbinhalt in einem E-Shop, die aufgerufenen Inhalte oder verwendete Funktionen eines Onlineangebotes speichern. Cookies können ferner zu unterschiedlichen Zwecken eingesetzt werden, z. B. zu Zwecken der Funktionsfähigkeit, Sicherheit und Komfort von Onlineangeboten sowie der Erstellung von Analysen der Besucherströme.
Es kommen auf dieser Website keine Cookies zum Einsatz.
...
GitHub: Leistungen auf dem Gebiet der Bereitstellung von informationstechnischer Infrastruktur und verbundenen Dienstleistungen (z. B. Speicherplatz und/oder Rechenkapazitäten);

**Dienstanbieter:** GitHub Inc., 88 Colin P Kelly Jr St, San Francisco, CA 94107, United States; Rechtsgrundlagen: Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO)
**Website:** https://github.com <br />
**Datenschutzerklärung:** https://docs.github.com/en/site-policy/privacy-policies <br />
**Auftragsverarbeitungsvertrag:** https://github.com/customer-terms/github-data-protection-agreement <br />
