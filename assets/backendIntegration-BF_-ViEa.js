import{Ht as e,_t as t,dt as n,gt as r,jt as i,n as a,rn as o,t as s,ut as c}from"./VRow-DD_A3p7A.js";import{L as l}from"./index-DfsswfGf.js";import{t as u}from"./marked.esm-iQpT2Gzx.js";var d=`/assets/backend1--aknY-7Q.png`,f=[`innerHTML`],p=[`innerHTML`],m=t({__name:`index`,setup(t){let m=u(`
...
`);return(t,u)=>(i(),n(s,null,{default:e(()=>[r(a,{cols:`12`},{default:e(()=>[c(`div`,{innerHTML:o(m)},null,8,f),r(l,{"max-height":`550px`,src:d}),c(`div`,{innerHTML:o(h)},null,8,p)]),_:1})]),_:1}))}});export{m as default};