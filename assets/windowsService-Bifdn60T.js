import{At as e,Vt as t,gt as n,ht as r,lt as i,n as a,nn as o,t as s,ut as c}from"./VRow-D0FG8Fr6.js";import{L as l}from"./index-DN8F7tUv.js";import{t as u}from"./marked.esm-Ccg6WR5l.js";var d=`/assets/service1-BsYLl4yH.png`,f=`/assets/service2-B0H53Tu-.png`,p=`/assets/service3-OvMyxfBZ.png`,m=`/assets/service4-ZsFamN79.png`,h=`/assets/service5-Cu4wr6cM.png`,g=[`innerHTML`],_=[`innerHTML`],v=[`innerHTML`],y=[`innerHTML`],b=[`innerHTML`],x=[`innerHTML`],S=n({__name:`index`,setup(n){let S=u(`
# Windows Service
...
`);return(n,u)=>(e(),c(s,null,{default:t(()=>[r(a,{cols:`12`},{default:t(()=>[i(`div`,{innerHTML:o(S)},null,8,g),r(l,{"max-height":`550px`,src:d}),i(`div`,{innerHTML:o(C)},null,8,_),r(l,{"max-height":`550px`,src:f}),i(`div`,{innerHTML:o(w)},null,8,v),r(l,{"max-height":`550px`,src:p}),i(`div`,{innerHTML:o(T)},null,8,y),r(l,{"max-height":`550px`,src:m}),i(`div`,{innerHTML:o(E)},null,8,b),r(l,{"max-height":`550px`,src:h}),i(`div`,{innerHTML:o(D)},null,8,x)]),_:1})]),_:1}))}});export{S as default};