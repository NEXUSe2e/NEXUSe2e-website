import{d as e}from"./marked.esm-C0Rlrcoy.js";import{d as h,c as l,w as n,V as u,a as d,b as t,u as i,e as c,o as m}from"./index-C0PiF630.js";const f=["innerHTML"],g=["innerHTML"],p=["innerHTML"],b=["innerHTML"],T=h({__name:"index",setup(w){const o=e(`
# Scheduling
---
...
`);return(j,v)=>(m(),l(u,null,{default:n(()=>[d(c,{cols:"12"},{default:n(()=>[t("div",{innerHTML:i(o)},null,8,f),t("div",{style:{"margin-bottom":"1rem"},innerHTML:i(s)},null,8,g),t("div",{innerHTML:i(r)},null,8,p),t("div",{style:{"margin-bottom":"1rem"},innerHTML:i(a)},null,8,b)]),_:1})]),_:1}))}});export{T as default};
