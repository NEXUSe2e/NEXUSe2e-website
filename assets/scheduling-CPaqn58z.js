import{Ht as e,_t as t,dt as n,gt as r,jt as i,n as a,rn as o,t as s,ut as c}from"./VRow-DyRmL_Vx.js";import{t as l}from"./marked.esm-CCiCWKfQ.js";var u=[`innerHTML`],d=[`innerHTML`],f=[`innerHTML`],p=[`innerHTML`],m=t({__name:`index`,setup(t){let m=l(`
# Scheduling
---
...
`);return(t,l)=>(i(),n(s,null,{default:e(()=>[r(a,{cols:`12`},{default:e(()=>[c(`div`,{innerHTML:o(m)},null,8,u),c(`div`,{style:{"margin-bottom":`1rem`},innerHTML:o(h)},null,8,d),c(`div`,{innerHTML:o(g)},null,8,f),c(`div`,{style:{"margin-bottom":`1rem`},innerHTML:o(_)},null,8,p)]),_:1})]),_:1}))}});export{m as default};