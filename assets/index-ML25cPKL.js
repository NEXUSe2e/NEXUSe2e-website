import{N as a}from"./NEXUSe2eImage-CAhcqOUd.js";import{d as e}from"./marked.esm-C0Rlrcoy.js";import{d as c,c as l,w as o,V as d,a as t,b as n,u as s,e as f,o as u}from"./index-C0PiF630.js";const h="/assets/services_flow-C55i1wx8.png",p=["innerHTML"],m=["innerHTML"],k=c({__name:"index",setup(w){const i=e(`
# Inflow and Outflow
---
...
`);return(v,y)=>(u(),l(d,null,{default:o(()=>[t(f,{cols:"12"},{default:o(()=>[n("div",{innerHTML:s(i)},null,8,p),t(a,{src:h}),n("div",{innerHTML:s(r)},null,8,m)]),_:1})]),_:1}))}});export{k as default};
