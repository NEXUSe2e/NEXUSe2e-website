import{d as e}from"./marked.esm-C0Rlrcoy.js";import{d as r,c as h,w as t,V as l,a as s,b as o,u as n,S as c,e as u,o as d}from"./index-C0PiF630.js";const m="/assets/test1-D3w9Ro9u.png",p=["innerHTML"],g=["innerHTML"],k=r({__name:"index",setup(w){const i=e(`
...
`);return(y,f)=>(d(),h(l,null,{default:t(()=>[s(u,{cols:"12"},{default:t(()=>[o("div",{innerHTML:n(i)},null,8,p),s(c,{"max-height":"550px",src:m}),o("div",{innerHTML:n(a)},null,8,g)]),_:1})]),_:1}))}});export{k as default};
