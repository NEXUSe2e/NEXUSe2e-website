import{At as e,Vt as t,gt as n,ht as r,lt as i,n as a,nn as o,t as s,ut as c}from"./VRow-D0FG8Fr6.js";import{L as l}from"./index-D6sb8cKR.js";import{t as u}from"./marked.esm-Ccg6WR5l.js";var d=`/assets/xsd1-yyfe1Aho.png`,f=`/assets/xsd2-C-AHukzb.png`,p=`/assets/xsd3-CdeqIwFT.png`,m=`/assets/xsd4-D5JAaG65.png`,h=[`innerHTML`],g=[`innerHTML`],_=[`innerHTML`],v=[`innerHTML`],y=[`innerHTML`],b=n({__name:`index`,setup(n){let b=u(`
...
`);return(n,u)=>(e(),c(s,null,{default:t(()=>[r(a,{cols:`12`},{default:t(()=>[i(`div`,{innerHTML:o(b)},null,8,h),r(l,{"max-height":`550px`,src:d}),i(`div`,{innerHTML:o(x)},null,8,g),r(l,{"max-height":`550px`,src:f}),i(`div`,{innerHTML:o(S)},null,8,_),r(l,{"max-height":`550px`,src:p}),i(`div`,{innerHTML:o(C)},null,8,v),r(l,{"max-height":`550px`,src:m}),i(`div`,{innerHTML:o(w)},null,8,y)]),_:1})]),_:1}))}});export{b as default};