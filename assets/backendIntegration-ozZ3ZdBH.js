import{At as e,Vt as t,gt as n,ht as r,lt as i,n as a,nn as o,t as s,ut as c}from"./VRow-D0FG8Fr6.js";import{L as l}from"./index-D6sb8cKR.js";import{t as u}from"./marked.esm-Ccg6WR5l.js";var d=`/assets/backend1--aknY-7Q.png`,f=[`innerHTML`],p=[`innerHTML`],m=n({__name:`index`,setup(n){let m=u(`
...
`);return(n,u)=>(e(),c(s,null,{default:t(()=>[r(a,{cols:`12`},{default:t(()=>[i(`div`,{innerHTML:o(m)},null,8,f),r(l,{"max-height":`550px`,src:d}),i(`div`,{innerHTML:o(h)},null,8,p)]),_:1})]),_:1}))}});export{m as default};