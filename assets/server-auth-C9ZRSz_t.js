import{At as e,Vt as t,gt as n,ht as r,lt as i,n as a,nn as o,t as s,ut as c}from"./VRow-D0FG8Fr6.js";import{t as l}from"./marked.esm-Ccg6WR5l.js";import{t as u}from"./NEXUSe2eImage-gxOX622o.js";var d=`/assets/connection_certificate-DDSxdGR_.png`,f=`/assets/partner_certificate-Dhd4lTfD.png`,p=`/assets/partner_certificate_container-CQIKkaPP.png`,m=[`innerHTML`],h=[`innerHTML`],g=[`innerHTML`],_=[`innerHTML`],v=[`innerHTML`],y=n({__name:`index`,setup(n){let y=l(`
...
`);return(n,l)=>(e(),c(s,null,{default:t(()=>[r(a,{cols:`12`},{default:t(()=>[i(`div`,{innerHTML:o(y)},null,8,m),i(`div`,{style:{"margin-bottom":`1rem`},innerHTML:o(b)},null,8,h),i(`div`,{innerHTML:o(x)},null,8,g),r(u,{src:d,style:{"padding-top":`0`}}),i(`div`,{innerHTML:o(S)},null,8,_),r(u,{src:f,style:{"padding-top":`0`}}),i(`div`,{innerHTML:o(C)},null,8,v),r(u,{src:p,style:{"padding-top":`0`}})]),_:1})]),_:1}))}});export{y as default};