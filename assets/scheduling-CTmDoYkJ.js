import{At as e,Vt as t,gt as n,ht as r,lt as i,n as a,nn as o,t as s,ut as c}from"./VRow-D0FG8Fr6.js";import{t as l}from"./marked.esm-Ccg6WR5l.js";var u=[`innerHTML`],d=[`innerHTML`],f=[`innerHTML`],p=[`innerHTML`],m=n({__name:`index`,setup(n){let m=l(`
# Scheduling
---
...
`);return(n,l)=>(e(),c(s,null,{default:t(()=>[r(a,{cols:`12`},{default:t(()=>[i(`div`,{innerHTML:o(m)},null,8,u),i(`div`,{style:{"margin-bottom":`1rem`},innerHTML:o(h)},null,8,d),i(`div`,{innerHTML:o(g)},null,8,f),i(`div`,{style:{"margin-bottom":`1rem`},innerHTML:o(_)},null,8,p)]),_:1})]),_:1}))}});export{m as default};