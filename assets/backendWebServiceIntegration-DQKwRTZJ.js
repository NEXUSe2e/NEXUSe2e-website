import{Ht as e,_t as t,dt as n,gt as r,jt as i,n as a,rn as o,t as s,ut as c}from"./VRow-DD_A3p7A.js";import{L as l}from"./index-DfsswfGf.js";import{t as u}from"./marked.esm-iQpT2Gzx.js";var d=`/assets/backendws1-BAhdKFu0.jpg`,f=`/assets/backendws2-BiNjVhgz.jpg`,p=[`innerHTML`],m=[`innerHTML`],h=[`innerHTML`],g=t({__name:`index`,setup(t){let g=u(`
...
`);return(t,u)=>(i(),n(s,null,{default:e(()=>[r(a,{cols:`12`},{default:e(()=>[c(`div`,{innerHTML:o(g)},null,8,p),r(l,{"max-height":`550px`,src:d}),c(`div`,{innerHTML:o(_)},null,8,m),r(l,{"max-height":`550px`,src:f}),c(`div`,{innerHTML:o(v)},null,8,h)]),_:1})]),_:1}))}});export{g as default};