import{Ct as e,Et as t,W as n,a as r,bt as i,ht as a,jt as o,mt as s,o as c,yt as l}from"./index-B21uHxR9.js";import{t as u}from"./marked.esm-DT5b__v5.js";var d=`/assets/backend1--aknY-7Q.png`,f=[`innerHTML`],p=[`innerHTML`],m=i({__name:`index`,setup(i){let m=u(`
...
`);return(i,u)=>(e(),a(r,null,{default:t(()=>[l(c,{cols:`12`},{default:t(()=>[s(`div`,{innerHTML:o(m)},null,8,f),l(n,{"max-height":`550px`,src:d}),s(`div`,{innerHTML:o(h)},null,8,p)]),_:1})]),_:1}))}});export{m as default};