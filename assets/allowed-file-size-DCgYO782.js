import{At as e,Vt as t,gt as n,ht as r,lt as i,n as a,nn as o,t as s,ut as c}from"./VRow-D0FG8Fr6.js";import{t as l}from"./marked.esm-Ccg6WR5l.js";var u=[`innerHTML`],d=[`innerHTML`],f=n({__name:`index`,setup(n){let f=l(`
# Allowed File Size
---
...
`);return(n,l)=>(e(),c(s,null,{default:t(()=>[r(a,{cols:`12`},{default:t(()=>[i(`div`,{innerHTML:o(f)},null,8,u),i(`div`,{innerHTML:o(p)},null,8,d)]),_:1})]),_:1}))}});export{f as default};