import{Ct as e,Et as t,W as n,a as r,bt as i,ht as a,jt as o,mt as s,o as c,yt as l}from"./index-B21uHxR9.js";import{t as u}from"./marked.esm-DT5b__v5.js";var d=`/assets/solution-CXbGlShX.jpg`,f=[`innerHTML`],p=i({__name:`index`,setup(i){let p=u(`
# The Solution
...
<br />
`);return(i,u)=>(e(),a(r,null,{default:t(()=>[l(c,{cols:`12`},{default:t(()=>[s(`div`,{innerHTML:o(p)},null,8,f),l(n,{"max-height":`550`,src:d})]),_:1})]),_:1}))}});export{p as default};