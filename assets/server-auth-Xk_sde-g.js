import{Ht as e,_t as t,dt as n,gt as r,jt as i,n as a,rn as o,t as s,ut as c}from"./VRow-DyRmL_Vx.js";import{t as l}from"./marked.esm-CCiCWKfQ.js";import{t as u}from"./NEXUSe2eImage-DiNNxQG7.js";var d=`/assets/connection_certificate-DDSxdGR_.png`,f=`/assets/partner_certificate-Dhd4lTfD.png`,p=`/assets/partner_certificate_container-CQIKkaPP.png`,m=[`innerHTML`],h=[`innerHTML`],g=[`innerHTML`],_=[`innerHTML`],v=[`innerHTML`],y=t({__name:`index`,setup(t){let y=l(`
...
`);return(t,l)=>(i(),n(s,null,{default:e(()=>[r(a,{cols:`12`},{default:e(()=>[c(`div`,{innerHTML:o(y)},null,8,m),c(`div`,{style:{"margin-bottom":`1rem`},innerHTML:o(b)},null,8,h),c(`div`,{innerHTML:o(x)},null,8,g),r(u,{src:d,style:{"padding-top":`0`}}),c(`div`,{innerHTML:o(S)},null,8,_),r(u,{src:f,style:{"padding-top":`0`}}),c(`div`,{innerHTML:o(C)},null,8,v),r(u,{src:p,style:{"padding-top":`0`}})]),_:1})]),_:1}))}});export{y as default};