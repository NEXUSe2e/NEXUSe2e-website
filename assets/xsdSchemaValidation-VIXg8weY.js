import{Ht as e,_t as t,dt as n,gt as r,jt as i,n as a,rn as o,t as s,ut as c}from"./VRow-DyRmL_Vx.js";import{L as l}from"./index-DBnzmR1l.js";import{t as u}from"./marked.esm-CCiCWKfQ.js";var d=`/assets/xsd1-yyfe1Aho.png`,f=`/assets/xsd2-C-AHukzb.png`,p=`/assets/xsd3-CdeqIwFT.png`,m=`/assets/xsd4-D5JAaG65.png`,h=[`innerHTML`],g=[`innerHTML`],_=[`innerHTML`],v=[`innerHTML`],y=[`innerHTML`],b=t({__name:`index`,setup(t){let b=u(`
...
`);return(t,u)=>(i(),n(s,null,{default:e(()=>[r(a,{cols:`12`},{default:e(()=>[c(`div`,{innerHTML:o(b)},null,8,h),r(l,{"max-height":`550px`,src:d}),c(`div`,{innerHTML:o(x)},null,8,g),r(l,{"max-height":`550px`,src:f}),c(`div`,{innerHTML:o(S)},null,8,_),r(l,{"max-height":`550px`,src:p}),c(`div`,{innerHTML:o(C)},null,8,v),r(l,{"max-height":`550px`,src:m}),c(`div`,{innerHTML:o(w)},null,8,y)]),_:1})]),_:1}))}});export{b as default};