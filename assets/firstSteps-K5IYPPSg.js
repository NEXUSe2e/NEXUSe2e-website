import{At as e,Vt as t,gt as n,ht as r,lt as i,n as a,nn as o,t as s,ut as c}from"./VRow-D0FG8Fr6.js";import{L as l}from"./index-D6sb8cKR.js";import{t as u}from"./marked.esm-Ccg6WR5l.js";var d=`/assets/first1-D5xFOWrW.jpg`,f=`/assets/first2-D8wtJbt0.jpg`,p=`/assets/first3-CGOtHTBa.jpg`,m=`/assets/first4-C_8nk97r.jpg`,h=`/assets/first5-D0S8O8SG.jpg`,g=`/assets/first6-CWOJYSVo.jpg`,_=[`innerHTML`],v=[`innerHTML`],y=[`innerHTML`],b=[`innerHTML`],x=[`innerHTML`],S=[`innerHTML`],C=[`innerHTML`],w=n({__name:`index`,setup(n){let w=u(`
...
`);return(n,u)=>(e(),c(s,null,{default:t(()=>[r(a,{cols:`12`},{default:t(()=>[i(`div`,{innerHTML:o(w)},null,8,_),r(l,{"max-height":`550px`,src:d}),i(`div`,{innerHTML:o(T)},null,8,v),r(l,{"max-height":`550px`,src:f}),i(`div`,{innerHTML:o(E)},null,8,y),r(l,{"max-height":`550px`,src:p}),i(`div`,{innerHTML:o(D)},null,8,b),r(l,{"max-height":`550px`,src:m}),i(`div`,{innerHTML:o(O)},null,8,x),r(l,{"max-height":`550px`,src:h}),i(`div`,{innerHTML:o(k)},null,8,S),r(l,{"max-height":`550px`,src:g}),i(`div`,{innerHTML:o(A)},null,8,C)]),_:1})]),_:1}))}});export{w as default};