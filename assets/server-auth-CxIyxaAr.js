import{Ct as e,Et as t,a as n,bt as r,ht as i,jt as a,mt as o,o as s,yt as c}from"./index-B21uHxR9.js";import{t as l}from"./marked.esm-DT5b__v5.js";import{t as u}from"./NEXUSe2eImage-gkMst0BH.js";var d=`/assets/connection_certificate-DDSxdGR_.png`,f=`/assets/partner_certificate-Dhd4lTfD.png`,p=`/assets/partner_certificate_container-CQIKkaPP.png`,m=[`innerHTML`],h=[`innerHTML`],g=[`innerHTML`],_=[`innerHTML`],v=[`innerHTML`],y=r({__name:`index`,setup(r){let y=l(`
