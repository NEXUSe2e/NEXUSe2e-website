import{d as e}from"./marked.esm-C0Rlrcoy.js";import{d as r,c,w as i,V as l,a as t,b as a,u as n,S as d,e as h,o as f}from"./index-C0PiF630.js";const u="/assets/backend1--aknY-7Q.png",m=["innerHTML"],p=["innerHTML"],T=r({__name:"index",setup(y){const o=e(`
...
`);return(g,b)=>(f(),c(l,null,{default:i(()=>[t(h,{cols:"12"},{default:i(()=>[a("div",{innerHTML:n(o)},null,8,m),t(d,{"max-height":"550px",src:u}),a("div",{innerHTML:n(s)},null,8,p)]),_:1})]),_:1}))}});export{T as default};
