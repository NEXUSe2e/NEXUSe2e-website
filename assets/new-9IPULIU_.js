import{At as e,Vt as t,gt as n,ht as r,lt as i,n as a,nn as o,t as s,ut as c}from"./VRow-D0FG8Fr6.js";import{t as l}from"./marked.esm-Ccg6WR5l.js";import{t as u}from"./NEXUSe2eImage-ClHFhnNY.js";var d=`/assets/light-dark-tYDlmkUc.png`,f=[`innerHTML`],p=[`innerHTML`],m=n({__name:`index`,setup(n){let m=l(`
# Home
...
`);return(n,l)=>(e(),c(s,null,{default:t(()=>[r(a,{cols:`12`},{default:t(()=>[i(`div`,{innerHTML:o(m)},null,8,f),r(u,{"max-height":`550px`,src:d}),i(`div`,{innerHTML:o(h)},null,8,p)]),_:1})]),_:1}))}});export{m as default};